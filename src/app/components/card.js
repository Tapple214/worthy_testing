...
import pic from '@/app/components/pp.PNG'
import pic2 from '@/app/components/slippers.jpg'
        ...
        <Container>
            <Row className='d-flex justify-content-center mx-auto w-auto h-auto'> 
                <Col xs='11' lg='6'> 
                    ...
                    <Image src={pic2} className={`card ${show ? 'dim' : ''}`} layout='fill' objectFit='cover' />
                                ...
                                <Col className='d-flex'>
                                    <div className='w-25'> 
                                        <div className='profilePic mt-1 ms-2'>
                                            <Image src={pic} width={1000} height={1000} className='rounded-circle' />
                                        </div>
                                    </div>
